...
#     def xyz_from_line(self, geom: shapely.LineString) -> List[XY[float] | XYZ[float]]:
#         lst = []
...
#     def __func_multi_line(
#         self, geom: shapely.MultiLineString, func: Callable
...
#     def merged_points_from_multi_line(
#         self, geom: shapely.MultiLineString
#     ) -> List[shapely.Point]:
#         return self.__func_merge(geom, self.points_from_multi_line)

#     def merged_xyz_from_multi_line(
#         self, geom: shapely.MultiLineString
#     ) -> List[XY | XYZ]:
#         return self.__func_merge(geom, self.xyz_from_multi_line)

#     def merged_x_y_z_from_multi_line(self, geom: shapely.MultiLineString) -> XY | XYZ:
#         x_lst, y_lst, z_lst = [], [], []
#         for line in shapely.get_parts(geom):
...
#     def merged_wkt_from_multi_line(self, geom: shapely.MultiLineString) -> List[str]:
#         return self.__func_merge(geom, self.wkt_from_multi_line)

#     def merged_wkb_from_multi_line(self, geom: shapely.MultiLineString) -> List[bytes]:
...
#     def __func_single_poly(self, geom: shapely.Polygon, func: Callable) -> PolyParts:
...
#     def __func_multi_poly(
#         self, geom: shapely.MultiPolygon, func: Callable
#     ) -> List[PolyParts]:
#         poly_parts_lst = []
...
#     def points_from_multi_poly(self, geom: shapely.MultiPolygon) -> List[PolyParts]:
...
#     def x_y_z_from_multi_poly(self, geom: shapely.MultiPolygon) -> List[PolyParts]:
#         return self.__func_multi_poly(geom, self.x_y_z_from_line)

#     def wkt_from_multi_poly(self, geom: shapely.MultiPolygon) -> List[PolyParts]:
#         return self.__func_multi_poly(geom, self.wkt_points_from_line)

#     def wkb_from_multi_poly(self, geom: shapely.MultiPolygon) -> List[PolyParts]:
#         return self.__func_multi_poly(geom, self.wkb_from_line)

#     def __func_merge_poly(
#         self, geom: shapely.MultiPolygon, func: Callable
#     ) -> List[Any]:
#         lst = []
...
#     def merged_points_from_multi_poly(
#         self, geom: shapely.MultiPolygon
#     ) -> List[shapely.Point]:
#         return self.__func_merge_poly(geom, self.points_from_multi_poly)

#     def merged_xyz_from_multi_poly(self, geom: shapely.MultiPolygon) -> List[XY | XYZ]:
#         return self.__func_merge_poly(geom, self.xyz_from_multi_poly)

#     def merged_x_y_z_from_multi_poly(self, geom: shapely.MultiPolygon) -> XY | XYZ:
#         x_lst, y_lst, z_lst = [], [], []
